    ...
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="bg-white rounded-xl shadow-2xl border border-gborder w-[600px]">
        ...
        <div className="p-6 space-y-5">
          <div>
            <label className="block text-sm font-medium text-gdark mb-1.5">Project</label>
            <input type="text" value={projectName} disabled
              className="w-full border border-gborder rounded-lg px-3 py-2.5 text-sm bg-gray-50 text-gray-500" />
          </div>

          <div>
            <label className="block text-sm font-medium text-gdark mb-1.5">Current quota</label>
          ...
          <div>
            <label className="block text-sm font-medium text-gdark mb-1.5">Requested quota</label>
            <input type="text" value="60 requests/min" disabled
              className="w-full border border-gborder rounded-lg px-3 py-2.5 text-sm bg-gray-50 text-gray-500" />
          </div>

          <div>
            <label className="block text-sm font-medium text-gdark mb-1.5">
            ...
            <textarea
              ...
              rows={4}
              disabled={processing}
              className="w-full border border-gborder rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gblue resize-none"
            />
